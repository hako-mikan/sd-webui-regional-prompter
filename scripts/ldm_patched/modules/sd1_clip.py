...
class SDClipModel(torch.nn.Module, ClipTokenWeightEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cpu", max_length=77,
                 freeze=True, layer="last", layer_idx=None, textmodel_json_config=None, dtype=None, model_class=scripts.ldm_patched.modules.clip_model.CLIPTextModel,
        ...
        with scripts.ldm_patched.modules.ops.use_patched_ops(scripts.ldm_patched.modules.ops.manual_cast):
