...
def cast_bias_weight(s, input):
    ...
    non_blocking = scripts.ldm_patched.modules.model_management.device_supports_non_blocking(input.device)
...
class disable_weight_init:
    class Linear(torch.nn.Linear):
        scripts.ldm_patched_cast_weights = False
        ...
        def forward(self, *args, **kwargs):
            if self.scripts.ldm_patched_cast_weights:
                return self.forward_scripts.ldm_patched_cast_weights(*args, **kwargs)
            else:
...
class manual_cast(disable_weight_init):
    class Linear(disable_weight_init.Linear):
        scripts.ldm_patched_cast_weights = True
