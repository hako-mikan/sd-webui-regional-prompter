...
import math
import struct
import scripts.ldm_patched.modules.checkpoint_pickle
...
def load_torch_file(ckpt, safe_load=False, device=None):
    ...
    if ckpt.lower().endswith(".safetensors"):
        ...
        if safe_load:
            ...
            pl_sd = torch.load(ckpt, map_location=device, pickle_module=scripts.ldm_patched.modules.checkpoint_pickle)
